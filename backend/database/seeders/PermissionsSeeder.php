...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'reply contact-messages']);
        ...
        Permission::create(['name' => 'broadcast subscriptions']);

        // Site settings permissions
        Permission::create(['name' => 'view settings']);
        Permission::create(['name' => 'edit settings']);
        Permission::create(['name' => 'manage api-keys']);
        ...
        $role->givePermissionTo(Permission::all()->filter(function ($permission) {
            // Admin has all permissions except API key management
            return $permission->name !== 'manage api-keys';
        }));
