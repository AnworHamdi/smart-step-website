...
const Button: React.FC<ButtonProps> = ({ children, onClick, to, variant = 'primary', className = '', type = 'button', disabled = false }) => {
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-smart-blue to-soft-blue text-white shadow-lg hover:shadow-xl focus-visible:ring-blue-300 [text-shadow:0_1px_2px_rgba(0,0,0,0.3)]',
